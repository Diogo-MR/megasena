...
if uploaded_file:
    ...
    if st.button("🤖 Sugerir jogo com IA"):
        ...
        sugestoes = [sorted(ranking.sample(15).index.tolist()) for _ in range(qtd_ia)]

        st.success(f"{qtd_ia} jogos sugeridos com IA (baseado nos padrões de acerto histórico):")
